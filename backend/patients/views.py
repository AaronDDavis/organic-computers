...
class PatientDashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context_data['latest_journey'] = self.request.user.profile.latest_journey
        ...
        context_data['specialist_label'] = context_data['latest_result'].get_specialist_display() if context_data['latest_result'] else None
